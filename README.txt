...
3. For every nose detected within the detected face calculate the following:
	- Center point of nose: x+ (((x + width)-x)/2) = width/2+x, y analogous, but moved up to the upper quarter, since the detected rectangle is not always in the real 	middle of the nose 
	- radius for nose: width of nose rectangle scaled by 26%. This factor fit the best in testing
4. Draw red circle
